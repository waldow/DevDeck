...
This file provides guidance to AI coding agents (Codex, and other tools) when working with code in this
repository. It is kept in sync with `CLAUDE.md` (same content, different audience line) — update both together.
